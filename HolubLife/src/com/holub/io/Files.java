...
public class Files {
     ...
     * @param description      the description of what the extension means. Not used if "extension"
     *                         is null.
     ...
     * @throws FileNotFoundException if the user didn't select a file. An exception toss (as
     *                               compared to a null return value) makes it easy to do the
     *                               following:
     *                               <PRE>
     *                               FileInputStream in = new FileInputStream( Files.userSelected(".",".txt","Text
     *                               File","Open"));
     *                               </PRE>
     */
    ...
    /**
     * A unit test class for the methods in this class. Run with java com.holub.io.Files\$Test
     */
    static class Test {
