...
public class Publisher {
    ...
    /**
     * Publish an event using the deliveryAgent. Note that this method isn't synchronized (and
     * doesn't have to be). Those subscribers that are on the list at the time the publish operation
     * is initiated will be notified. (So, in theory, it's possible for an object that cancels its
